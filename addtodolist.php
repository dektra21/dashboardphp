...
<ul class="uk-nav uk-dropdown-nav">
   <li class="uk-active"><a href="addcategory.php">Add To Do List</a></li>
   <hr>
...
<form method="post" action="proccesstodolist.php">
<div class=" uk-card-body uk-width-1-3 uk-align-center" >
   ...
   <h4 class="uk-text-center uk-h4">To Do</h4> 
    ...
    <br><br>
<select name="category" class="uk-select" style="border:1px solid black; border-radius:25px;" >
